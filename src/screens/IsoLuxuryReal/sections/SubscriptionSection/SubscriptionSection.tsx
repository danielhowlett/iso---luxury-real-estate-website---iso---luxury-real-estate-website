      ...
      <div className="w-full max-w-[1200px] mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              <form 
                action="https://script.google.com/macros/s/AKfycbyNMg-VTxQbDeKZUDzkq0rMwzUyNw1IOqMLdtSlpqvdqcuw3fWcp5sIvVbRjuuQkhsw/exec"
                method="POST"
                id="contact-form"
              ...
              >
                ...
                <button
                  type="submit"
                  id="submit-btn"
                  className="bg-white hover:bg-[#ffffffee] text-black font-semibold text-base [font-family:'Plus_Jakarta_Sans',Helvetica] py-4 px-8 rounded-full transition-all duration-300"
                >
                  Get a Free Quote
                </button>
                ...
                <p 
                  id="form-response" 
                  style={{ display: 'none' }} 
                  className="text-green-400 text-sm [font-family:'Plus_Jakarta_Sans',Helvetica] text-center"
                >
